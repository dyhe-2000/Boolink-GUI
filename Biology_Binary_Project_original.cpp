...
public:
	...
	void simulation() {
		...
		std::ofstream resultFile;
		resultFile.open("result.txt");
		std::cout << "Run howmany initializations of 20 timesteps?\n";
		int initializationsCount = promptUserInputAnInterger();
	...
	void initializeNodesInNetworkFromAFile() {
		Node* nodeAddress;
		nodeAddress = new Node;
		nodeAddress->setNodeState(0); // ABA stste here
		nodeAddress->setNodeName("input");
		listOfNodes.push_back(nodeAddress);
	...
	std::vector<int> runTimeStepWithoutResetEachTime(std::ofstream& resultFile, int timeStepCount) {
...
//void setUpTheNetWork() {
//	Network aNetwork;
//	Node Input("Input", 1);
//	aNetwork.push_in_nodes(Input);
//	std::cout << "How many nodes? (not including input and closure) : ";
//	int userInputNodeCount;
//	std::cin >> userInputNodeCount;
//	for (int i = 0; i < userInputNodeCount; ++i) {
//		int j = generateState();
//		Node tempNode("",j);
//		aNetwork.push_in_nodes(tempNode);
//	}
//	Node Closure("Closure", generateState());
//	aNetwork.push_in_nodes(Closure);
//	std::cout << "Boolean operator precedence: ~ > ^ > v" << std::endl;
//	std::cout << "Please enter " << userInputNodeCount - 1 << "boolean functions" << std::endl;
//	std::cout << "do not enter parentheses and separate operator and node number" << std::endl;
//	for (int i = 0; i < userInputNodeCount; i++) {
//		std::cout << "Enter boolean function for node" << i + 1 << " : " << std::endl;
//
//	}
//	aNetwork.printOutNetWork();
//}

//int main() {
//	std::cout << "setting up the first Node\n";
//	std::string userInputtedString = getUserInputNodeName();
//	int userInputNodeState = getUserInputNodeState();
//	Node theNode1(userInputtedString, userInputNodeState);
//
//	std::cout << "setting up the target Node\n";
//	userInputtedString = getUserInputNodeName();
//    userInputNodeState = getUserInputNodeState();
//	Node theNode2(userInputtedString, userInputNodeState);
//
//	std::cout << "setting up the connection between two Nodes\n";
//	int userInputConnectionState = getUserInputConnectionState();
//	Connection theConnection1to2(theNode1,userInputConnectionState, theNode2);
//
//	std::cout << "\nNode1 is connected to Node2, this is the initial setup:\n";
//	theConnection1to2.printTheConnection();
//
//	std::cout << "\nNode1 is connected to Node2, this is after the process:\n";
//	theConnection1to2.update();
//	theConnection1to2.printTheConnection();
//
//	std::cout << "\nEND OF THE SIMULATION\n";
//	std::cout << "Would you like to try again? Enter \"N\" to stop the program, other input will start another simulation.\n";
//	std::string userInputForContinue;
//	std::cin >> userInputForContinue;
//	if (userInputForContinue[0] != 'N') {
//		main();
//	}
//	
//	return 0;
...
//int main() {
//	Node Input("Input", 1);
//	Node Closure("Closure", 0);
//	Node One("1", 0);
//	Node Two("2", 0);
//	Node Three("3", 0);
//	Node Four("4", 0);
//	Logic_Or theLogicOr;
//	BooleanFunction booleanFunction0(One);
//	BooleanFunction booleanFunction1(Two);
//	BooleanFunction booleanFunction2(Three);
//	BooleanFunction booleanFunction3(Four);
//	BooleanFunction booleanFunction4(Closure);
//	/*Logic_Equal test;
//	test.setValue(1);
//	test.push_in_nodes(Closure);
//	std::cout << test.execute_logic() << std::endl;*/
//
//	std::cout << One.getNodeState() << std::endl;
//	Logic_Equal b0;
//	b0.push_in_nodes(Input);
//	booleanFunction0.push_in_operations(b0);
//	booleanFunction0.executeFunction();
//	std::cout << One.getNodeState() << std::endl;
//
//	std::cout << Three.getNodeState() << std::endl;
//	Logic_Equal b2;
//	b2.push_in_nodes(Input);
//	booleanFunction2.push_in_operations(b2);
//	booleanFunction2.executeFunction();
//	std::cout << Three.getNodeState() << std::endl;
//
//	std::cout << Two.getNodeState() << std::endl;
//	Logic_Not b1not;
//	b1not.push_in_nodes(Three);
//	Logic_And b1and(b1not.getResult());
//	b1and.push_in_nodes(One);
//	Logic_Equal b1equal(b1and.getResult());
//	booleanFunction1.push_in_operations(b1not).push_in_operations(b1and).push_in_operations(b1equal);
//	booleanFunction1.executeFunction();
//	std::cout << Two.getNodeState() << std::endl;
//
//	return 0;
//}
...
//	Node Fo("4", 0);
//	Node Fi("5", 0);
//	aNetwork.push_in_nodes(Z).push_in_nodes(O).push_in_nodes(TW).push_in_nodes(TH).push_in_nodes(Fo).push_in_nodes(Fi);
//	aNetwork.printOutNetWork();
//	BooleanFunction booleanFunction0(aNetwork.getNodeInNetwork(1));
//	BooleanFunction booleanFunction1(aNetwork.getNodeInNetwork(2));
//	BooleanFunction booleanFunction2(aNetwork.getNodeInNetwork(3));
//	BooleanFunction booleanFunction3(aNetwork.getNodeInNetwork(4));
//	BooleanFunction booleanFunction4(aNetwork.getNodeInNetwork(5));
//
//	//aNetwork.getNodeInNetwork(1).printNodeInfo();
//	Logic_Equal b0equal;
//	b0equal.push_in_nodes(aNetwork.getNodeInNetwork(0));
//	booleanFunction0.push_in_operations(b0equal);
//	booleanFunction0.executeFunction();
//	//aNetwork.getNodeInNetwork(1).printNodeInfo();
//
//	Logic_Equal b2equal;
//	b2equal.push_in_nodes(aNetwork.getNodeInNetwork(0));
//	booleanFunction2.push_in_operations(b2equal);
//	//booleanFunction2.executeFunction();
//
//	Logic_Not b1not;
//	b1not.push_in_nodes(aNetwork.getNodeInNetwork(3));
//	b1not.execute_logic();
//	Logic_And b1and(b1not.getResult());
//	b1and.push_in_nodes(aNetwork.getNodeInNetwork(1));
//	b1and.execute_logic();
//	Logic_Equal b1equal(b1and.getResult());
//	booleanFunction1.push_in_operations(b1not).push_in_operations(b1and).push_in_operations(b1equal);
//	booleanFunction1.executeFunction();
//
//	/*aNetwork.push_in_functions(booleanFunction0).push_in_functions(booleanFunction2).push_in_functions(booleanFunction1);
//	aNetwork.executeAllFunctionsInTheNetwork();*/
//	std::cout << std::endl;
//	aNetwork.printOutNetWork();
//	return 0;
//}
